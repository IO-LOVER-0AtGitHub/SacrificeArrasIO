...
- Now, lets break it down. The first thing you'll see is `visible 0,`. Don't worry, it is.
...
- First of all, it says "glitch". This is the server provider your using. Say if your using Heroku instead, you would put Heroku
...
- Afterwards, theres `prefer: !0,`. I wouldn't mess with it but it makes you automaiticly connect to that server by default
